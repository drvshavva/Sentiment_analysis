...
file_ = open("C:\\Users\\user\\Desktop\\sentiment_analysis\\shutterstock_1073953772.jpg", "rb")
contents = file_.read()
data_url = base64.b64encode(contents).decode("utf-8")
file_.close()

page_bg_img = '''
<img src="C:\\Users\\user\\Desktop\\sentiment_analysis\\shutterstock_1073953772.jpg">
<style>
body {
    color: #fff;
...
def classification_report_tf_idf(x_train, x_test, y_train, y_test, max_features: int = None, analyzer: str = "word",
                                 n_gram=(1, 1)):
    models = []
    models.append(
        ('LogisticRegression', linear_model.LogisticRegression(solver='newton-cg', multi_class='multinomial')))
